...
export class ExperiencesService {
  ...
  async catalogExperiences(params: {
    ...
    const mapped = data.map((exp: any) => {
      ...
      return {
        ...
        reviewStars: meta.reviewStars ?? exp.ratingAverage,
        googleReviewStars: meta.googleReviewStars ?? meta.reviewStars ?? exp.ratingAverage,
  ...
  async getExperienceById(id: string) {
    ...
    return {
      ...
      closingTime: meta.closingTime || '',
      closedDays: meta.closedDays || '',
      reviewStars: meta.reviewStars ?? experience.ratingAverage,
      googleReviewStars: meta.googleReviewStars ?? meta.reviewStars ?? experience.ratingAverage,
      bookingType: meta.bookingType || '',
      accessibilityNotes: meta.accessibilityNotes || '',
      bestFor: meta.bestFor || '',
    };
